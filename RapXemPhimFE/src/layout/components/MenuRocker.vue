				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu show" data-bs-popper="static">
						<router-link to="/admin/ve">
							<li>
								<a class="dropdown-item" href="/admin/ve"><i class="bx bx-right-arrow-alt"></i>Vé</a>
							</li>
						</router-link>
						<router-link to="/admin/dich-vu">
							<li>
								<a class="dropdown-item" href="/admin/dich-vu"><i class="bx bx-right-arrow-alt"></i>Dịch
									Vụ</a>
							</li>
						</router-link>
...
/* Khi link đang active (được click) → giữ màu đen luôn */
