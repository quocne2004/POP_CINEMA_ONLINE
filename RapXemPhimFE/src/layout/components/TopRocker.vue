	...
	<div class="topbar d-flex align-items-center">
		<nav class="navbar navbar-expand">
			<div class="topbar-logo-header">
				...
				<div class="">
					<h4 class="logo-text " style="color:  #410441 ;">PoP Cinema</h4>
				</div>
			</div>
			...
			<div class="user-box dropdown">
				<template v-if="user_login">
					<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
						...
						<img src="https://i.pravatar.cc/48?img=12" class="user-img"
							alt="user avatar">
						<div class="user-info ps-3">
							<p class="user-name mb-0">{{ user_login.hoVaTen }}</p>
							<p class="designattion mb-0">{{ user_login.chucVu.tenChucVu }}</p>
						</div>
					</a>
					<ul class="dropdown-menu dropdown-menu-end" v-if="user_login">
				...
				<template v-if="!user_login">
					<ul class="navbar-nav mb-2 mb-lg-0">
						...
						<router-link to="/admin/dang-nhap">
							<li class="nav-item">
								<a class="nav-link active fs-6" aria-current="page" href="/admin/dang-nhap"> Đăng
									Nhập</a>
