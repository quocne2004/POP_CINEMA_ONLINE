                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ value.soLuongPhimDangChieu }} </td>
                                </tr>
                                </template>
                            </tbody>
                        </table>
...
export default {
    ...
    methods: {
          getData() {
            ...
            axios
                .post('http://localhost:8080/api/admin/thong-ke/thong-ke-phim-dang-chieu', payload, {
                    headers: {
                ...
                .then((response) => {
                    this.chartData.labels = response.data.list_ngay,
                        this.chartData.datasets[0].data = response.data.list_so_luong_phim,
