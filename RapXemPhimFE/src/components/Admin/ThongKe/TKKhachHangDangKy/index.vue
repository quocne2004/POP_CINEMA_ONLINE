                    ...
                    <div class="mb-3">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-lg-2 col-md-12">
                                <label for="">&nbsp;</label>
                                <button @click="getData()" class="btn btn-primary w-100">Thống Kê</button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                <template v-for="(value, index) in list_data" :key="index">
                                    <tr>
                                        ...
                                        <td class="text-center">{{ value.soLuongKhacHangMoi }}</td>
                                    </tr>
                                </template>
                            </tbody>
                        </table>
...
export default {
    ...
    methods: {
        getData() {
            ...
            axios
                .post('http://localhost:8080/api/admin/thong-ke/thong-ke-khach-hang', payload, {
                    headers: {
                ...
                .then((response) => {
                    this.chartData.labels = response.data.list_ngay,
                        this.chartData.datasets[0].data = response.data.list_so_luong_khach_hang_moi,
