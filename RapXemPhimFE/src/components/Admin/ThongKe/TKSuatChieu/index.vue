                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ value.soLuongSuatChieu }}</td>
                                </tr>
                                </template>
                            </tbody>
                        </table>
...
export default {
    ...
    methods: {
        getData() {
            ...
            axios
                .post('http://localhost:8080/api/admin/thong-ke/thong-ke-suat-chieu', payload, {
                    headers: {
                ...
                .then((response) => {
                    this.chartData.labels = response.data.list_ngay,
                        this.chartData.datasets[0].data = response.data.list_so_luong_suat_chieu,
